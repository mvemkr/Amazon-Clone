    ...
    Product
        ...
        .exec( function(err, products){
            ...
            Product.count().exec(function(err, count){
                if(err) return next(err);
                res.render(mainViews + 'product-main', {
                    products: products,
                    pages: count / perPage
                });
            });
...
router.get('/search', function(req, res, next) {
    if(req.query.q) {
        ...
        //                 res.render(mainViews + 'search-result', {
        //                     query: req.query.q,
        //                     data: subOrderList
        //                 });
        //             }
...
router.post('/payment', function(req, res, next) {
    ...
    var currentCharges = Math.round(req.body.stripeMoney * 100); // stripe deals in cents
